...
void mpu9250_get_data(I2C_Handle *i2c, float *ax, float *ay, float *az, float *gx, float *gy, float *gz) {
	...
	*ax = (float) (((int16_t)(rawData[0] << 8) | rawData[1]))*aRes - accelBias[0];
	*ay = (float) (((int16_t)(rawData[2] << 8) | rawData[3]))*aRes - accelBias[1];
	*az = (float) (((int16_t)(rawData[4] << 8) | rawData[5]))*aRes - accelBias[2];

	// JTKJ: Convert g values into degrees per second
	*gx = (float) (((int16_t)(rawData[8] << 8) | rawData[9]))*gRes;
	*gy = (float) (((int16_t)(rawData[10] << 8) | rawData[11]))*gRes;
	*gz = (float) (((int16_t)(rawData[12] << 8) | rawData[13]))*gRes;
}
